...
AVAILABLE_CLASSES = {
    ...
    49: "Orange", 50: "Broccoli", 51: "Carrot", 52: "Hotdog", 53: "Pizza", 54: "Don: Donut",
    ...
    while True:
        for s in STREAMS:
            ...
            try:
                ...
                pass
        time.sleep(0.25) # Beschleunigt auf 4 FPS für das Live-View Overlay
...
def dashboard():
    ...
    <body>
                    ...
                    <div class="card">
                        <h2>
                            ...
                            <span id="pipeline-status" class="status-badge {{ 'status-active' if pipeline_active else 'status-inactive' }}">
                                {{ 'Active' if pipeline_active else 'Inactive' }}
                            </span>
                        </h2>
                    ...
                    <div class="card">
                        ...
                        <div>
                            ...
                            <div class="stream-container">
                                ...
                                <!-- Thumbnail Container (Jetzt klickbar für Live View) -->
                    ...
                    <div class="card">
                        ...
                        <form action="/save_settings" method="POST">
                            ...
                            <div class="settings-group" style="margin-top: 15px;">
                                <label>Object Categories (YOLOv10)</label>
                            ...
                            <button type="submit" class="btn-save"><i class="fa-solid fa-floppy-disk"></i> Apply Settings</button>
                        </form>
                    </div>
                </div>
        ...
        <script>
            ...
            // --- Thumbnail Auto-Refresh (Dashboard) ---
            setInterval(() => {
            ...
            }, 1000); // 1 fps im Dashboard

            // --- Live View Overlay (4 FPS) ---
            ...
            // --- Lightbox-Logik (für Video-Aufzeichnungen) ---
