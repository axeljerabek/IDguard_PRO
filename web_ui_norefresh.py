...
def is_pipeline_running():
    """Prüft, ob der Hauptprozess der Pipeline läuft."""
    # HINWEIS: Ersetze 'DEIN_PIPELINE_SCRIPT.py' durch den tatsächlichen Namen deines laufenden Skripts
                ...
                <div>
                    <div class="card">
                        <h2>
                            ...
                            <span class="status-badge {{ 'status-active' if pipeline_active else 'status-inactive' }}">
                ...
                <div>
                    <div class="card" style="height: calc(100% - 3rem);">
                        <h2>
                            ...
                            <span style="background: var(--border); padding: 2px 8px; border-radius: 12px; font-size: 0.8rem; margin-left: 10px;">{{ recent_events|length }}</span>
                        </h2>
        ...
        <script>
            ...
            function updateCategorySummary() {
                ...
                if (checkedBoxes.length === 0) {
                    summary.innerText = "Keine Klassen gewählt";
                } else if (checkedBoxes.length === 1) {
                    summary.innerText = "1 Klasse ausgewählt";
                } else {
                    summary.innerText = checkedBoxes.length + " Klassen ausgewählt";
                }
            }
